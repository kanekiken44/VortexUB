...
import codecs
import socket
rizoelzzspark = logging.getLogger("IMAGE_DL")
...
class googleimagesdownload:
    ...
    def download_page(self, url):
        ...
        if cur_version >= version:  # If the Current Version of Python is 3.0 or above
            try:
                ...
                rizoelzzspark.info("Could not open URL. Please check your internet connection and/or ssl settings \n"
    ...
    def download_extended_page(self, url, chromedriver):
        ...
        try:
            ...
            rizoelzzspark.info("Looks like we cannot locate the path the 'chromedriver' (use the '--chromedriver' "
        ...
        time.sleep(1)
        rizoelzzspark.info("Getting you a lot of images. This may take a few moments...")
        ...
        rizoelzzspark.info("Reached end of Page.")
        time.sleep(0.5)
    ...
    def single_image(self, image_url):
        ...
        try:
            ...
            raise e
        rizoelzzspark.info("completed ====> " + image_name.encode('raw_unicode_escape').decode('utf-8'))
        return
    ...
    def keywords_from_file(self, file_name):
        ...
        with codecs.open(file_name, 'r', encoding='utf-8-sig') as f:
            if '.csv' in file_name:
                ...
                rizoelzzspark.info("Invalid file type: Valid file types are either .txt or .csv \n"
                      "exiting...")
                sys.exit()
    ...
    def download_image_thumbnail(self, image_url, main_directory, dir_name, return_image_name, print_urls,
        ...
        if print_urls or no_download:
            rizoelzzspark.info("Image URL: " + image_url)
        if no_download:
        ...
        try:
            ...
            try:
                ...
                if print_size:
                    rizoelzzspark.info("Image Size: " + str(self.file_size(path)))
            ...
            for sky in suffix_keywords:  # 2.for every suffix keywords
                ...
                while i < len(search_keyword):  # 3.for every main keyword
                    ...
                    if not arguments["silent_mode"]:
                        ...
                        rizoelzzspark.info("Evaluating...")
                    else:
                        rizoelzzspark.info("Downloading images for: " + (pky) + (search_keyword[i]) + (sky) + " ...")
                    ...
                    if not arguments["silent_mode"]:
                        if arguments['no_download']:
                            rizoelzzspark.info("Getting URLs without downloading images...")
                        else:
                            rizoelzzspark.info("Starting Download...")
...
def main():
    ...
    for arguments in records:
        ...
        if not arguments["silent_mode"]:
            ...
            rizoelzzspark.info("Total errors: " + str(total_errors))
            rizoelzzspark.info("Total time taken: " + str(total_time) + " Seconds")
