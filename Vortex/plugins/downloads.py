...
from Vortex import CMD_HELP, LOGS
from Vortex.utils import admin_cmd, humanbytes, time_formatter
...
@Vortex.on(admin_cmd(pattern=f"gdl", outgoing=True))
@Vortex.on(sudo_cmd(pattern=f"gdl", allow_sudo=True))
...
@Vortex.on(admin_cmd(outgoing=True, pattern=r"mega(?: |$)(.*)"))
