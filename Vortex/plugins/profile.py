...
from Vortex import get_user_from_event
...
@Vortex.on(admin_cmd(pattern="pjoin (.*)"))
@Vortex.on(sudo_cmd(pattern="pjoin (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Vortex.on(admin_cmd(pattern="join (.*)"))
@Vortex.on(sudo_cmd(pattern="join (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    bc = event.pattern_match.group(1)
...
@Vortex.on(admin_cmd(pattern="leave (.*)"))
@Vortex.on(sudo_cmd(pattern="leave (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Vortex.on(admin_cmd(pattern="pbio (.*)"))
@Vortex.on(sudo_cmd(pattern="pbio (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Vortex.on(sudo_cmd(pattern="pname ((.|\n)*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Vortex.on(admin_cmd(pattern="check"))
@Vortex.on(sudo_cmd(pattern="check$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Vortex.on(admin_cmd(pattern="ppic"))
@Vortex.on(sudo_cmd(pattern="ppic$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Vortex.on(admin_cmd(outgoing=True, pattern="username (.*)"))
@Vortex.on(sudo_cmd(pattern="username (.*)", allow_sudo=True))
...
@Vortex.on(admin_cmd(outgoing=True, pattern="count$"))
@Vortex.on(sudo_cmd(pattern="count$", allow_sudo=True))
...
@Vortex.on(admin_cmd(outgoing=True, pattern=r"delpfp"))
@Vortex.on(sudo_cmd(pattern="delpfp$", allow_sudo=True))
...
@Vortex.on(admin_cmd(pattern="myusernames$"))
@Vortex.on(sudo_cmd(pattern="myusernames$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    await event.delete()
