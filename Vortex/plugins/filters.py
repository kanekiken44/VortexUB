...
from Vortex.plugins.sql_helper.filter_sql import (
    add_filter,
    get_all_filters,
    remove_all_filters,
    remove_filter,
...
@Vortex.on(admin_cmd(pattern="savefilter (.*)"))
@Vortex.on(sudo_cmd(pattern="savefilter (.*)", allow_sudo=True))
...
@Vortex.on(admin_cmd(pattern="listfilters"))
@Vortex.on(sudo_cmd(pattern="listfilters", allow_sudo=True))
...
@Vortex.on(admin_cmd(pattern="clearfilter (.*)"))
@Vortex.on(sudo_cmd(pattern="clearfilter (.*)", allow_sudo=True))
...
@Vortex.on(admin_cmd(pattern="clearallfilters"))
@Vortex.on(sudo_cmd(pattern="clearallfilters", allow_sudo=True))
