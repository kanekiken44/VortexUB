...
@Vortex.on(admin_cmd(pattern="lyrics ?(.*)"))
@Vortex.on(sudo_cmd(pattern="lyrics ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with borg.conversation(bot) as conv:
        try:
            ...
            vortexlyricdata = await conv.get_response()
            await ok.edit(vortexlyricdata.text + "\n\nLyrics Generated By Your Vortex userbot")
