...
import Vortex.plugins.sql_helper.blacklist_sql as sql
...
@Vortex.on(admin_cmd(pattern="addblacklist ((.|\n)*)"))
@Vortex.on(sudo_cmd(pattern="addblacklist ((.|\n)*)"))
...
@Vortex.on(admin_cmd(pattern="listblacklist"))
@Vortex.on(sudo_cmd(pattern="listblacklist"))
...
@Vortex.on(admin_cmd(pattern="rmblacklist ((.|\n)*)"))
@Vortex.on(sudo_cmd(pattern="rmblacklist ((.|\n)*)"))
