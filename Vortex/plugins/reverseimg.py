...
@Vortex.on(admin_cmd(outgoing=True, pattern=r"reverse(?: |)(\d*)"))
@Vortex.on(sudo_cmd(allow_sudo=True, pattern=r"reverse(?: |)(\d*)"))
@errors_handler
async def okgoogle(img):
    ...
    if message and message.media:
        ...
        await eor(img, "`Reply to photo or sticker idiot.`")
        return
    ...
    if photo:
        ...
        if response != 400:
            ...
            await eor(img, "`Google said not found.`")
            return
