...
@Vortex.on(admin_cmd(pattern="get_ad?(m)in ?(.*)"))
@Vortex.on(sudo_cmd(pattern="get_ad?(m)in ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Vortex.on(admin_cmd(pattern="get_id"))
@Vortex.on(sudo_cmd(pattern="get_id", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
...
@Vortex.on(admin_cmd(pattern="get_bot ?(.*)"))
@Vortex.on(sudo_cmd(pattern="get_bot ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
CMD_HELP.update(
    {
        "get_infos": ".get_admin\nUse - To get info about admins in a chat.\
        \n\n.get_id\nUse - Get chat id.\
