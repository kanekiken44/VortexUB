...
@Vortex.on(admin_cmd(pattern="calc"))
@Vortex.on(sudo_cmd(pattern="calc", allow_sudo=True))
async def icalc(e):
    udB.delete("calc")
...
async def _(e):
    ...
    calc = e.builder.article("Calc", text="★ ʀɪᴢᴏᴇʟ ɪɴʟɪɴᴇ ᴄᴀʟᴄᴜʟᴀᴛᴏʀ ★", buttons=lst)
    await e.answer([calc])
