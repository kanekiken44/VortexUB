...
from Vortex.utils import admin_cmd, errors_handler

BOTLOG_CHATID = Var.PRIVATE_GROUP_ID


@Vortex.on(admin_cmd(outgoing=True, pattern="purge"))
@Vortex.on(sudo_cmd(allow_sudo=True, pattern="purge"))
@errors_handler
...
@Vortex.on(admin_cmd(outgoing=True, pattern="purgeme"))
@errors_handler
...
@Vortex.on(admin_cmd(outgoing=True, pattern="del"))
@errors_handler
...
@Vortex.on(admin_cmd(outgoing=True, pattern="edit"))
@errors_handler
...
@Vortex.on(admin_cmd(outgoing=True, pattern="sd"))
@errors_handler
...
CMD_HELP.update(
    {
        "sd": ".sd <x> <message>\
\nUsage: Creates a message that selfdestructs in x seconds. Note- Put less than 60 as x)"
    }
)
