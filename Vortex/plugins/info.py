...
@Vortex.on(admin_cmd(pattern="info(?: |$)(.*)"))
async def who(event):
...
async def fetch_info(replied_user, event):
    ...
    if user_id != (await event.client.get_me()).id:
        ...
        common_chat += "It's me Vortex."

    caption = "<u><b>Userinfo Fetched From Vortex Database</b></u>\n\n"
    ...
    caption += f" <b>Is It A Bot</b>: <code>{is_bot}</code> \n"
    ...
    caption += f" <b>Number of Display Pictures</b>: <code>{replied_user_profile_photos_count}</code> \n"
    caption += f"\n <b>Common Groups</b>: <code>{common_chat} </code>\n\n"
    caption += f" <b>Permanent Link</b>: "
...
CMD_HELP.update(
    {
        "info": ".info <id/reply to mssg>\nUse - Fetchs out user details from Vortex userbot database and shows results."
    }
)
