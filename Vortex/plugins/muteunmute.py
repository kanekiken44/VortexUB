...
@Vortex.on(admin_cmd(pattern="mute ?(\d+)?"))
@Vortex.on(sudo_cmd(outgoing=True, pattern="mute ?(\d+)?", allow_sudo=True))
...
@Vortex.on(admin_cmd(pattern="unmute ?(\d+)?"))
@Vortex.on(sudo_cmd(outgoing=True, pattern="unmute ?(\d+)?", allow_sudo=True))
