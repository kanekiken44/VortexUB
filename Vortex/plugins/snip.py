...
from Vortex.plugins.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@Vortex.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
...
@Vortex.on(admin_cmd(pattern="snips (.*)"))
...
@Vortex.on(admin_cmd(pattern="snipl"))
...
@Vortex.on(admin_cmd(pattern=r"snipd (\S+)"))
