...
class Var(object):
    ...
    CUSTOM_ALIVE = os.environ.get("CUSTOM_ALIVE", "https://telegra.ph/file/cc29c25774e5906547310.jpg")
    CUSTOM_ALIVE_EMOJI = os.environ.get("CUSTOM_ALIVE_EMOJI", None)
    CUSTOM_AFK = os.environ.get("CUSTOM_AFK", None)
    CUSTOM_STICKER_PACK_NAME = os.environ.get("CUSTOM_STICKER_PACK_NAME", None)
    BOT_PIC = os.environ.get("BOT_PIC", 
"https://telegra.ph/file/cc29c25774e5906547310.jpg")
...
if ENV:
    class Config(object):
        ...
        PRIVATE_CHANNEL_BOT_API_ID = int(os.environ.get(
            "PRIVATE_CHANNEL_BOT_API_ID", -575167524))
